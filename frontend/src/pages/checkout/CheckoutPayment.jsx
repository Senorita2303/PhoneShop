...
import { IconButton, Typography, RadioGroup, Radio, FormControlLabel, Stack } from '@mui/material';
...
export default function CheckoutPayment() {
    ...
    const paymentOpts = [
        ...
        {
            value: 'Thanh toán qua ví ZaloPay',
            name: 'Thanh toán qua ví ZaloPay'
        }
    ];
                                ...
                                <div className="col-span-2 my-3 flex-col">
                                    <div className="flex-col rounded-lg bg-white py-3 px-4">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button className="flex items-center" onClick={() => { handleBackStep(); handleBackStep(); }} >
                                        ...
                                        {
                                            allItems?.map((e, index) => {
                                                const { quantity, productVariant } = e;
                                                return (
                                    ...
                                    <div className="my-3 flex-col rounded-lg bg-white py-3 px-4 max-md:hidden">
                                        ...
                                        />
                                        {/* <RadioGroup onChange={handleChangePaymentMethod} defaultValue="Thanh toán khi nhận hàng">
                                            <Stack>
                                                {paymentOpts.map((method) => {
                                                    const { value, name } = method;
                                                    return (
